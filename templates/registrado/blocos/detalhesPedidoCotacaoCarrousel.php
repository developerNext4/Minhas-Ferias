<script type="text/javascript" src="templates/registrado/js/jsor-jcarousel-8e3df57/lib/jquery.jcarousel.min.js"></script>
<link rel="stylesheet" type="text/css" href="templates/registrado/js/jsor-jcarousel-8e3df57/skins/tango/skin.css" />
<script>
		...
		?>
			...
			?>
             <div class="row">
                    ...
                    <p>
                    	<h4><a href="index.php?pg=5&CTC_ID=<?php echo ($CTC_ID);?>">Alterar para visualização em lista</a></h4>
                    </p>
                    <p>
                    	<?php
                        ...
                        <?php
							...
							while ($lQry = mysql_fetch_array ($kQry)){
								...
								$qqQry = mysql_query ("SELECT COUNT(*) AS COUNT FROM tb_avaliacao WHERE AVL_AVALIADO = '$lQry[USR_ID]'");
                        		 	...
                        		 	<table style="border-collapse:collapse" border='1'>
                        		 		<tr>
                        		 			<td>
			                        		 	<table>
			                        		 		<tr>
			                        		 			<td><img width="40" height="40" alt="http://static.flickr.com/75/199481072_b4a0d09597_s.jpg" src="http://static.flickr.com/75/199481072_b4a0d09597_s.jpg"></td>
			                        		 			<td><?php echo (utf8_encode ($lQry['USR_NOME'])); ?></td>
			                        		 		</tr>
			                        		 		<tr>
			                        		 			<td></td><td><?php echo ($wwQry['COUNT']); ?> avaliações</td>
			                        		 		</tr>
			                        		 		<tr>
			                        		 			<td colspan="2"><strong>Valor Total:</strong> R$ <?php echo ($TOTAL); ?></td>
			                        		 		</tr>
			                        		 		<tr>
			                        		 			<td></td><td><input type="checkbox" name="CTP_<?php echo ($i); ?>" id="CTP_<?php echo ($i); ?>" value="<?php echo ($lQry["USR_ID"]); ?>" onclick="verificarComparar();" /></td>
			                        		 		</tr>
			                        		 	</table>
			                        		 </td>
			                        	 </tr>
