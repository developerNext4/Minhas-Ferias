...
if($blocos->bloco("atualizarCadastroAgente")){
	$blocos->blocoview("atualizarCadastroAgente");
}
...
if($blocos->bloco("propostasEfetuadas")){
	$blocos->blocoview("propostasEfetuadas");
}
if($blocos->bloco("visualizarScore")){
	$blocos->blocoview("visualizarScore");
}
if($blocos->bloco("minhaConta")){
	$blocos->blocoview("minhaConta");
}
?>
