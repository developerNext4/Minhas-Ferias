...
<div class="container">
  <div class="row">
    <div class="span6 offset6 areaLogin">
      ...
      <div class="linksTop"><a href="#"> Esqueceu sua senha?</a> | <a href="#"> Cadastre-se</a> | <a href="#">Cadastro Fornecedores</a></div>--><br><br><div class="socialMedia"><span class="socialTul"><?php echo ($_SESSION["ADM_NOME"]);?> Seja Bem-Vindo <a href="logout.php">Sair</a></span></div><br><br>
    </div>
  </div>
  </div>
